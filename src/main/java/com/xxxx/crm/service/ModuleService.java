...
public class ModuleService extends BaseService<Module,Integer> {
    ...
    public void addModule(Module module){
        ...
        AssertUtil.isTrue(null != moduleMapper.queryModuleByGradeAndModuleName(grade,module.getModuleName()),"模块名称不能为空！");
        ...
        //父级菜单 parentId 二级|二级菜单（菜单|按钮 grade=1或2） 非空，父级菜单必须存在
        if (grade != 0){
            //非空
    ...
    public void updateModule(Module module){
        ...
        //权限码 optValue   非空,权限码 optValue   不可重复
        AssertUtil.isTrue(StringUtils.isBlank(module.getOptValue()),"权限码不能为空！");
        //通过权限码查询资源对象
